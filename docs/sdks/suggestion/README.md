...
<!-- UsageSnippet language="typescript" operationID="addSuggestionComment" method="post" path="/portals/{portalID}/suggestions/{suggestionID}/comments" -->
```typescript
import { Egain } from "@egain/egain-api-typescript";
...
async function run() {
  await egain.portal.suggestion.addSuggestionComment({
    acceptLanguage: "en-US",
    portalID: "PROD-1000",
    suggestionID: "PROD-11829",
    createComment: {
...
```typescript
import { EgainCore } from "@egain/egain-api-typescript/core.js";
import { portalSuggestionAddSuggestionComment } from "@egain/egain-api-typescript/funcs/portalSuggestionAddSuggestionComment.js";
...
async function run() {
  const res = await portalSuggestionAddSuggestionComment(egain, {
    acceptLanguage: "en-US",
    portalID: "PROD-1000",
    suggestionID: "PROD-11829",
    createComment: {
  ...
  if (res.ok) {
    ...
    console.log("portalSuggestionAddSuggestionComment failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AddSuggestionCommentRequest](../../models/operations/addsuggestioncommentrequest.md)                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
