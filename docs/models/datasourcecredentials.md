...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| `accessKeyId`                                                            | *string*                                                                 | :heavy_minus_sign:                                                       | Access key for S3 credentials datasource. Provide along with Secret Key. |
| `secretAccessKey`                                                        | *string*                                                                 | :heavy_minus_sign:                                                       | Secret key for S3 credentials datasource. Provide along with Access Key. |
