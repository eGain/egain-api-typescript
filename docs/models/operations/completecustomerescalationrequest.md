...
```typescript
import { CompleteCustomerEscalationRequest } from "@egain/egain-api-typescript/models/operations";

let value: CompleteCustomerEscalationRequest = {
  acceptLanguage: "en-US",
  portalID: "PROD-1000",
  escalationId: "03305328-cbe9-4ad0-a778-45ab44532bc0",
};
```
