...
```typescript
import { GetTagCategoriesForInterestForPortalRequest } from "@egain/egain-api-typescript/models/operations";

let value: GetTagCategoriesForInterestForPortalRequest = {
