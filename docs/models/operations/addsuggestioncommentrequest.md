...
```typescript
import { AddSuggestionCommentRequest } from "@egain/egain-api-typescript/models/operations";

let value: AddSuggestionCommentRequest = {
...
| `createComment`                                                                                                                 | [models.CreateComment](../../models/createcomment.md)                                                                           | :heavy_check_mark:                                                                                                              | N/A                                                                                                                             |                                                                                                                                 |