...
| `contextualSummary`                                                                                                   | *string*                                                                                                              | :heavy_minus_sign:                                                                                                    | Contextual Summary generated as part of metadata for embedding.                                                       | The summary of the lending FAQ...                                                                                     |
...
| `relevanceScore`                                                                                                      | *number*                                                                                                              | :heavy_check_mark:                                                                                                    | Generated confidence score (0.0-1.0) for the snippet's relevance to the query.                                        | 0.8                                                                                                                   |