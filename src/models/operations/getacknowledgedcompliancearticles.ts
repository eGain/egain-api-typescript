...
export type GetAcknowledgedComplianceArticlesRequest = {
  /**
...
/** @internal */
export const GetAcknowledgedComplianceArticlesRequest$inboundSchema: z.ZodType<
...
/** @internal */
export type GetAcknowledgedComplianceArticlesRequest$Outbound = {
...
/** @internal */
export const GetAcknowledgedComplianceArticlesRequest$outboundSchema: z.ZodType<
  GetAcknowledgedComplianceArticlesRequest$Outbound,
  z.ZodTypeDef,
  GetAcknowledgedComplianceArticlesRequest
> = z.object({
 ...
 */
export namespace GetAcknowledgedComplianceArticlesRequest$ {
  /** @deprecated use `GetAcknowledgedComplianceArticlesRequest$inboundSchema` instead. */
  export const inboundSchema =
    GetAcknowledgedComplianceArticlesRequest$inboundSchema;
  /** @deprecated use `GetAcknowledgedComplianceArticlesRequest$outboundSchema` instead. */
  export const outboundSchema =
    GetAcknowledgedComplianceArticlesRequest$outboundSchema;
  /** @deprecated use `GetAcknowledgedComplianceArticlesRequest$Outbound` instead. */
  export type Outbound = GetAcknowledgedComplianceArticlesRequest$Outbound;
}

export function getAcknowledgedComplianceArticlesRequestToJSON(
  getAcknowledgedComplianceArticlesRequest:
    GetAcknowledgedComplianceArticlesRequest,
): string {
  return JSON.stringify(
    GetAcknowledgedComplianceArticlesRequest$outboundSchema.parse(
      getAcknowledgedComplianceArticlesRequest,
    ),
  );
}

export function getAcknowledgedComplianceArticlesRequestFromJSON(
  jsonString: string,
): SafeParseResult<
  GetAcknowledgedComplianceArticlesRequest,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetAcknowledgedComplianceArticlesRequest$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetAcknowledgedComplianceArticlesRequest' from JSON`,
  );
}
