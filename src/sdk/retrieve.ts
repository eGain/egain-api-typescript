...
import { aiservicesRetrievePostPortalIDRetrieve } from "../funcs/aiservicesRetrievePostPortalIDRetrieve.js";
...
export class Retrieve extends ClientSDK {
   ...
   */
  async postPortalIDRetrieve(
    request: operations.PostPortalIDRetrieveRequest,
    options?: RequestOptions,
  ): Promise<models.RetrieveResponse> {
    return unwrapAsync(aiservicesRetrievePostPortalIDRetrieve(
      this,
      request,
      options,
    ));
