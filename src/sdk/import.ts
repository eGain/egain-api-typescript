...
import { contentImportCreateImport } from "../funcs/contentImportCreateImport.js";
import { contentImportCreateImportValidation } from "../funcs/contentImportCreateImportValidation.js";
import { contentImportGetImportContent } from "../funcs/contentImportGetImportContent.js";
import { contentImportPatchImportContentValidation } from "../funcs/contentImportPatchImportContentValidation.js";
...
export class Import extends ClientSDK {
  ...
  ): Promise<operations.CreateImportResponse | undefined> {
    return unwrapAsync(contentImportCreateImport(
      this,
      request,
      options,
    ));
   ...
   */
  async getImportContent(
    request: operations.GetImportContentRequest,
    options?: RequestOptions,
  ): Promise<models.ImportStatus> {
    return unwrapAsync(contentImportGetImportContent(
      this,
      request,
      options,
    ));
   ...
   */
  async createImportValidation(
    request: models.ValidateImportContent,
    options?: RequestOptions,
  ): Promise<operations.CreateImportValidationResponse | undefined> {
    return unwrapAsync(contentImportCreateImportValidation(
      this,
      request,
      options,
    ));
   ...
   */
  async patchImportContentValidation(
    request: operations.PatchImportContentValidationRequest,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(contentImportPatchImportContentValidation(
      this,
      request,
      options,
    ));
