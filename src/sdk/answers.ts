...
import { aiservicesAnswersPostPortalIDAnswers } from "../funcs/aiservicesAnswersPostPortalIDAnswers.js";
...
export class Answers extends ClientSDK {
   ...
   */
  async postPortalIDAnswers(
    request: operations.PostPortalIDAnswersRequest,
    options?: RequestOptions,
  ): Promise<models.AnswersResponse> {
    return unwrapAsync(aiservicesAnswersPostPortalIDAnswers(
      this,
      request,
      options,
    ));
