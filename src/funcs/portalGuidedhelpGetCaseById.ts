 ...
 */
export function portalGuidedhelpGetCaseById(
  client: EgainCore,
  request: operations.GetCaseByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Case | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCaseByIdRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    caseID: encodeSimple("caseID", payload.caseID, {
      explode: false,
  ...
  const query = queryJoin(
    encodeFormQuery({
      "caseAdditionalAttributes": payload.caseAdditionalAttributes,
    }, { explode: false }),
    encodeFormQuery({
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Case$inboundSchema.optional()),
    M.nil(204, models.Case$inboundSchema.optional()),
