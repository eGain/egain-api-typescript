 ...
 */
export function portalArticleGetAttachmentByIdInPortal(
  client: EgainCore,
  request: operations.GetAttachmentByIdInPortalRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AttachmentContentResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAttachmentByIdInPortalRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AttachmentContentResult$inboundSchema.optional()),
    M.nil(204, models.AttachmentContentResult$inboundSchema.optional()),
