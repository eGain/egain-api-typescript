 ...
 */
export function portalUserprofileGetAllUserProfiles(
  client: EgainCore,
  request: operations.GetAllUserProfilesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.UserProfiles | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllUserProfilesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/userprofiles")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserProfiles$inboundSchema.optional()),
    M.nil(204, models.UserProfiles$inboundSchema.optional()),
