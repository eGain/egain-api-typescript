 ...
 */
export function portalEscalationStartCustomerEscalation(
  client: EgainCore,
  request: operations.StartCustomerEscalationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StartCustomerEscalationResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StartCustomerEscalationRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.StartEscalationRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/portals/{portalID}/escalate")(pathParams);
  ...
  const context = {
    ...
    operationID: "startCustomerEscalation",
    oAuth2Scopes: [],
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "406", "415", "4XX", "500", "5XX"],
  ...
  >(
    M.nil(
      201,
      operations.StartCustomerEscalationResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
