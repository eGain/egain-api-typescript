 ...
 */
export function portalArticleGetArticleAttachmentById(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetArticleAttachmentByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/articles/attachments/{attachmentID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AttachmentContentResult$inboundSchema),
