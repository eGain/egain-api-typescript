 ...
 */
export function portalAttachmentUploadAttachment(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UploadAttachmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/attachment/upload")();
