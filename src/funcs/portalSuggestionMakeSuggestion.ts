 ...
 */
export function portalSuggestionMakeSuggestion(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MakeSuggestionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateSuggestion, { explode: true });
