 ...
 */
export function portalGuidedhelpGetClusterByCasebaseReleaseId(
  client: EgainCore,
  request: operations.GetClusterByCasebaseReleaseIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ClusterResults | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetClusterByCasebaseReleaseIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ClusterResults$inboundSchema.optional()),
    M.nil(204, models.ClusterResults$inboundSchema.optional()),
