 ...
 */
export function portalGuidedhelpGetAllCasebasesReleases(
  client: EgainCore,
  request: operations.GetAllCasebasesReleasesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.CasebaseResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllCasebasesReleasesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/gh/casebasereleases")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CasebaseResult$inboundSchema.optional()),
    M.nil(204, models.CasebaseResult$inboundSchema.optional()),
