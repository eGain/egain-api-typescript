 ...
 */
export function portalGeneralGetPortalDetailsById(
  client: EgainCore,
  request: operations.GetPortalDetailsByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Portal | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPortalDetailsByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Portal$inboundSchema.optional()),
    M.nil(204, models.Portal$inboundSchema.optional()),
