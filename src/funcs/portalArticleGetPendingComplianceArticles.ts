 ...
 */
export function portalArticleGetPendingComplianceArticles(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPendingComplianceArticlesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/portals/{portalID}/articles/compliance/pending")(
    pathParams,
  );
