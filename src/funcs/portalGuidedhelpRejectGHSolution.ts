 ...
 */
export function portalGuidedhelpRejectGHSolution(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RejectGHSolutionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.QuickpickRating, { explode: true });
  ...
  const path = pathToFunc("/portals/{portalID}/gh/cases/{caseID}/reject")(
    pathParams,
  );
  ...
  >(
    M.nil(201, z.void()),
    M.jsonErr(
      [400, 401, 403, 404, 406, 412],
      errors.WSErrorCommon$inboundSchema,
    ),
