 ...
 */
export function portalArticleGetArticleByIdWithEditions(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetArticleByIdWithEditionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/articles/{articleID}/witheditions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ArticleWithEditions$inboundSchema),
