 ...
 */
export function portalArticleGetMySubscription(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMySubscriptionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/articles/subscribed")(
    pathParams,
  );
