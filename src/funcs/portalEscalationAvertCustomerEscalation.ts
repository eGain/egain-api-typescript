 ...
 */
export function portalEscalationAvertCustomerEscalation(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AvertCustomerEscalationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/escalate/{escalationId}/avert")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "avertCustomerEscalation",
    oAuth2Scopes: null,
