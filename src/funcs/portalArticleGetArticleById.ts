 ...
 */
export function portalArticleGetArticleById(
  client: EgainCore,
  request: operations.GetArticleByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Article | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetArticleByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Article$inboundSchema.optional()),
    M.nil(204, models.Article$inboundSchema.optional()),
