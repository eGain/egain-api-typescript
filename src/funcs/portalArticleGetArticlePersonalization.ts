 ...
 */
export function portalArticleGetArticlePersonalization(
  client: EgainCore,
  request: operations.GetArticlePersonalizationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Personalization | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetArticlePersonalizationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Personalization$inboundSchema.optional()),
    M.nil(204, models.Personalization$inboundSchema.optional()),
