 ...
 */
export function portalArticlelistsGetArticleListDetails(
  client: EgainCore,
  request: operations.GetArticleListDetailsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ArticleList | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetArticleListDetailsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/articlelists/{listID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ArticleList$inboundSchema.optional()),
    M.nil(204, models.ArticleList$inboundSchema.optional()),
