 ...
 */
export function portalSuggestionAddSuggestionComment(
  client: EgainCore,
  request: operations.AddSuggestionCommentRequest,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AddSuggestionCommentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateComment, { explode: true });
