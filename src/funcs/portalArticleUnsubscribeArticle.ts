 ...
 */
export function portalArticleUnsubscribeArticle(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UnsubscribeArticleRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    "unsubscriptionToken": payload.unsubscriptionToken,
  });
