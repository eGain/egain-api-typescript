 ...
 */
export function portalEscalationCompleteCustomerEscalation(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CompleteCustomerEscalationRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "completeCustomerEscalation",
    oAuth2Scopes: null,
