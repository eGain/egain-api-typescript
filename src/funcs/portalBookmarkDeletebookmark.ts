 ...
 */
export function portalBookmarkDeletebookmark(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeletebookmarkRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    bookmarkID: encodeSimple("bookmarkID", payload.bookmarkID, {
      explode: false,
  ...
  const path = pathToFunc("/portals/{portalID}/bookmarks/{bookmarkID}")(
    pathParams,
  );
