 ...
 */
export function portalConnectorssearcheventsCreateSearchResultEventForConnectors(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateSearchResultEventForConnectorsRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.createSearchResultEventForConnectors,
    { explode: true },
  );
  ...
  const path = pathToFunc("/portals/{portalID}/search/connectors/event")(
    pathParams,
  );
