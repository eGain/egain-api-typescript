 ...
 */
export function portalSuggestionGetSuggestionAttachments(
  client: EgainCore,
  request: operations.GetSuggestionAttachmentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Attachments | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSuggestionAttachmentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Attachments$inboundSchema.optional()),
    M.nil(204, models.Attachments$inboundSchema.optional()),
