 ...
 */
export function portalArticleComplyArticle(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ComplyArticleRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/articles/{articleID}/comply")(
    pathParams,
  );
