...
import { PatchImportContentValidationServerList } from "../models/operations/patchimportcontentvalidation.js";
 ...
 */
export function contentImportPatchImportContentValidation(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchImportContentValidationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PatchImportContentValidationServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "patchImportContentValidation",
    oAuth2Scopes: [],
