 ...
 */
export function portalSuggestionGetSuggestionComments(
  client: EgainCore,
  request: operations.GetSuggestionCommentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Comments | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSuggestionCommentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Comments$inboundSchema.optional()),
    M.nil(204, models.Comments$inboundSchema.optional()),
