 ...
 */
export function portalArticleGetAllArticleTypes(
  client: EgainCore,
  request: operations.GetAllArticleTypesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.ArticleTypeInfo> | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllArticleTypesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/articletypes")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ArticleTypeInfo$inboundSchema).optional()),
    M.nil(204, z.array(models.ArticleTypeInfo$inboundSchema).optional()),
