 ...
 */
export function portalUserprofileSelectUserProfile(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SelectUserProfileRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    userProfileID: encodeSimple("userProfileID", payload.userProfileID, {
      explode: false,
      charEncoding: "percent",
    }),
  };
