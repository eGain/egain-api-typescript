 ...
 */
export function portalArticleGetArticlesInTopic(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetArticlesInTopicRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/articles")(pathParams);
