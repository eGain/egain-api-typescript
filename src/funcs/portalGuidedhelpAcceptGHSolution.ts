 ...
 */
export function portalGuidedhelpAcceptGHSolution(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AcceptGHSolutionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/gh/cases/{caseID}/accept")(
    pathParams,
  );
