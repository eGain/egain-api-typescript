 ...
 */
export function portalArticleAddAsReference(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddAsReferenceRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ArticleActivityLink, {
    explode: true,
  });
