 ...
 */
export function portalTopicGetancestortopics(
  client: EgainCore,
  request: operations.GetancestortopicsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TopicResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetancestortopicsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/topics/{topicID}/parents")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TopicResult$inboundSchema.optional()),
    M.nil(204, models.TopicResult$inboundSchema.optional()),
