 ...
 */
export function portalArticleGetArticlePermissionsById(
  client: EgainCore,
  request: operations.GetArticlePermissionsByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ArticlePermissionsResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetArticlePermissionsByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ArticlePermissionsResult$inboundSchema.optional()),
    M.nil(204, models.ArticlePermissionsResult$inboundSchema.optional()),
