 ...
 */
export function portalTopicGetalltopics(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetalltopicsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/topics")(pathParams);
