 ...
 */
export function portalBookmarkAddbookmark(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddbookmarkRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateBookmark, { explode: true });
