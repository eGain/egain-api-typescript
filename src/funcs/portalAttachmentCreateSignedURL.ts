 ...
 */
export function portalAttachmentCreateSignedURL(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateSignedURLRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.AttachmentUpload, { explode: true });

  const path = pathToFunc("/attachment/preupload")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Attachment$inboundSchema),
