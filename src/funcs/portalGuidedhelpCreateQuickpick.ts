 ...
 */
export function portalGuidedhelpCreateQuickpick(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateQuickpickRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateQuickpick, { explode: true });
