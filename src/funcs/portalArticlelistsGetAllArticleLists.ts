 ...
 */
export function portalArticlelistsGetAllArticleLists(
  client: EgainCore,
  request: operations.GetAllArticleListsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ArticleListsResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllArticleListsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/articlelists")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ArticleListsResult$inboundSchema.optional()),
    M.nil(204, models.ArticleListsResult$inboundSchema.optional()),
