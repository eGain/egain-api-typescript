 ...
 */
export function portalUserdetailsGetUserDetails(
  client: EgainCore,
  request: operations.GetUserDetailsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.UserDetails | undefined,
...
> {
  ...
  const path = pathToFunc("/portals/user")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserDetails$inboundSchema.optional()),
    M.nil(204, models.UserDetails$inboundSchema.optional()),
