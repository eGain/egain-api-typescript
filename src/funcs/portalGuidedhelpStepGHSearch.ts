 ...
 */
export function portalGuidedhelpStepGHSearch(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StepGHSearchRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.GHStepSearchRequest, {
    explode: true,
  });
