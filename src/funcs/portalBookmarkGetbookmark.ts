 ...
 */
export function portalBookmarkGetbookmark(
  client: EgainCore,
  request: operations.GetbookmarkRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.BookmarkResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetbookmarkRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/bookmarks")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BookmarkResult$inboundSchema.optional()),
    M.nil(204, models.BookmarkResult$inboundSchema.optional()),
