 ...
 */
export function portalUsermilestonesGetUserMilestones(
  client: EgainCore,
  request: operations.GetUserMilestonesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Milestones | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUserMilestonesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/user/milestones")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Milestones$inboundSchema.optional()),
    M.nil(204, models.Milestones$inboundSchema.optional()),
