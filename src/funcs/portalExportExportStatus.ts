...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ExportStatusRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/content/export/{jobID}/status")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ExportStatus$inboundSchema),
