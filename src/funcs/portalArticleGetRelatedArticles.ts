 ...
 */
export function portalArticleGetRelatedArticles(
  client: EgainCore,
  request: operations.GetRelatedArticlesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ArticleResults | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRelatedArticlesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/articles/{articleID}/related")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ArticleResults$inboundSchema.optional()),
    M.nil(204, models.ArticleResults$inboundSchema.optional()),
