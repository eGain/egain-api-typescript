 ...
 */
export function portalSuggestionGetSuggestionAttachmentById(
  client: EgainCore,
  request: operations.GetSuggestionAttachmentByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.SuggestionAttachment | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSuggestionAttachmentByIdRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    "attachmentAdditionalAttributes": payload.attachmentAdditionalAttributes,
  }, { explode: false });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SuggestionAttachment$inboundSchema.optional()),
    M.nil(204, models.SuggestionAttachment$inboundSchema.optional()),
