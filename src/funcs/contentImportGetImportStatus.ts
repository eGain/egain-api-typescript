...
import { GetImportStatusServerList } from "../models/operations/getimportstatus.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetImportStatusRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetImportStatusServerList[0], { charEncoding: "percent" })();
