 ...
 */
export function portalGeneralGetAllPortals(
  client: EgainCore,
  request: operations.GetAllPortalsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.PortalResult | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllPortalsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PortalResult$inboundSchema.optional()),
    M.nil(204, models.PortalResult$inboundSchema.optional()),
