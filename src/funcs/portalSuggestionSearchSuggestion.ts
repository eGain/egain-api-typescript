 ...
 */
export function portalSuggestionSearchSuggestion(
  client: EgainCore,
  request: operations.SearchSuggestionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.Suggestions | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SearchSuggestionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/suggestions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Suggestions$inboundSchema.optional()),
    M.nil(204, models.Suggestions$inboundSchema.optional()),
