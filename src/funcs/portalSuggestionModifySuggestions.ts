 ...
 */
export function portalSuggestionModifySuggestions(
  client: EgainCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ModifySuggestionsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ModifySuggestion, { explode: true });
