 ...
 */
export function portalSuggestionGetRelatedArticlesForSuggestion(
  client: EgainCore,
  request: operations.GetRelatedArticlesForSuggestionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FeedbackArticleForSuggestion | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRelatedArticlesForSuggestionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FeedbackArticleForSuggestion$inboundSchema.optional()),
    M.nil(204, models.FeedbackArticleForSuggestion$inboundSchema.optional()),
