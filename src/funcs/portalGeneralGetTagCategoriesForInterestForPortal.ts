 ...
 */
export function portalGeneralGetTagCategoriesForInterestForPortal(
  client: EgainCore,
  request: operations.GetTagCategoriesForInterestForPortalRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TagCategoriesForInterest | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTagCategoriesForInterestForPortalRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/portals/{portalID}/tagcategoriesforinterest")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TagCategoriesForInterest$inboundSchema.optional()),
    M.nil(204, models.TagCategoriesForInterest$inboundSchema.optional()),
